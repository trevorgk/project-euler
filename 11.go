...
func euler_11 () {
	...
	for i := 0; i < size; i++ {
		for j := 0; j < size; j++ {
			...
			ttb := TopToBottom(grid, i, j)			
			if ttb > maxProduct {
				maxProduct = ttb
				maxText = fmt.Sprintln("Top to bottom starting at position", i, j, "yields product of", ttb)
			}
			
			ltr := LeftToRight(grid, i, j)			
			if ltr > maxProduct {
				maxProduct = ltr
				maxText = fmt.Sprintln("Left to right starting at position", i, j, "yields product of", ltr)
			}
			tltbr := TopLeftToBottomRight(grid, i, j)			
			if tltbr > maxProduct {
				maxProduct = tltbr
				maxText = fmt.Sprintln("Top left to bottom right starting at position", i, j, "yields product of", tltbr)
			}
			blttr := BottomLeftToTopRight(grid, i, j)			
			if blttr > maxProduct {
				maxProduct = blttr
				maxText = fmt.Sprintln("Bottom left to top right starting at position", i, j, "yields product of", blttr)
			}
		}
	}
...
func TopToBottom(grid [][]int, x int, y int) int {
	min, max, size := 0, 20, 4
	...
	//fmt.Println("top to bottom product of", x, "and", y, "is", product)
	return product	
}


func LeftToRight(grid [][]int, x int, y int) int {
	min, max, size := 0, 20, 4
	...
	//fmt.Println("left to right product of", x, "and", y, "is", product)
	return product	
}

func TopLeftToBottomRight(grid [][]int, x int, y int) int {
	min, max, size := 0, 20, 4
	...
	//fmt.Println("top left to bottom right product of", x, "and", y, "is", product)
	return product	
}

func BottomLeftToTopRight(grid [][]int, x int, y int) int {
	min, max, size := 0, 20, 4
	...
	//fmt.Println("bottom left to top right product of", x, "and", y, "is", product)
	return product	
}
